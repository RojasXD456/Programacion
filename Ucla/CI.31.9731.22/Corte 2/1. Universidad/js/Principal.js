...
* Lisando Alvarado, se conoce: el código. La sección tiene 5 estudiantes inscritos
...
salida.innerHTML +=
iEstu.reportarEstudiante(estu.nombre, estu.notaFinal()) + "<br>";
sec.procesarEstudiante(estu); }

salida.innerHTML += iSec.reportarSeccion(
sec.contadorAprobados(),
sec.promedioSeccion(),
sec.nombreEstudianteMayorNota(),
sec.nombreEstudianteMenorNota()
);